...
config_path_prefix="/home/roydig/multibot/freqtrade-docker"
config_path_suffix="/user_data/"
...
backup_blacklist_filename="blacklist-binance.json_BACKUP_"
...
do
	...
	cd $config_path_prefix$n$config_path_suffix
    pwd
    echo "Now processing directory: "$config_path_prefix$n$config_path_suffix
